...
- `boot` shows boot drive and kernel base information
- `irq` shows interrupt subsystem status
- `ticks` prints the raw PIT tick counter
- `uptime` prints uptime in seconds and ticks
